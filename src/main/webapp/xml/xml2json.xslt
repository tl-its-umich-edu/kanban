...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:String="http://xml.apache.org/xalan/java/java.lang.String" xmlns:urwg="http://www.gridforum.org/2003/ur-wg" version="2.0">
   ...
   <xsl:template match="rss">
      ...
      <xsl:for-each select="channel/item">
         ...
         <xsl:text>",</xsl:text>
         <xsl:text>"affectsVersion" : "</xsl:text>
